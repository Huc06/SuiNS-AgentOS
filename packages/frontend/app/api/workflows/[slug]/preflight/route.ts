import type { WorkflowGraph } from "@agentos-sui/sdk/node";
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  // Workflow subdomains always execute under their owning agent's Passport.
  // Resolve the workflow first so a same-slug registry agent cannot override
  // the owner identity used by the matching run route.
