module agentos::trading_agent {
    ...
    public struct TradeRecord has store, drop {
        timestamp: u64,
        asset_from: String,
        asset_to: String,
        amount_from: u64,
    ...
    public fun propose_trade(
        ...
        assert!(portfolio.daily_spent + amount_from <= portfolio.daily_limit, ERROR_SPENDING_LIMIT_EXCEEDED);
    ...
    public fun get_total_value(portfolio: &Portfolio): u64 {
        portfolio.total_value
    }

    public fun get_daily_limit(portfolio: &Portfolio): u64 {
        portfolio.daily_limit
    }

    public fun get_daily_spent(portfolio: &Portfolio): u64 {
        portfolio.daily_spent
    }

    public fun is_active(portfolio: &Portfolio): bool {
        portfolio.is_active
    }
